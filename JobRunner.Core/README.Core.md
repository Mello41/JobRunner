...
## последние изменения (28.06.26 v.2.0.0)

1. разграничение IRetryPolicyStrategy от Polly (пространство имен совпадало)
2. Добавлен IJobAdapterFactory для переопделения класса JobAdapter на сервере
3. добавление параметров ID в логику фичи уведомлений задачи